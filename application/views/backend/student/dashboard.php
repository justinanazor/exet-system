                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    <h4>
                                    <?php echo $this->db->get('guardian')->num_rows();?>  
                                    </h4>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    <h4>
                                    <?php echo $this->db->get('hostel')->num_rows();?>  
                                    </h4>
                                    <span class="text-muted"><?php echo get_phrase('Hostel Admin');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    <h4>
                                    <?php echo $this->db->get('security')->num_rows();?>  
                                    </h4>
                                    <span class="text-muted"><?php echo get_phrase('security');?></span>
                                </div>
                            </div>
                        </div>
                    </div>
