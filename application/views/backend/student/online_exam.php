		...
		<div class="panel panel-info">
			<div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('Test_list');?></div>
				...
				<table class="table">
					<thead>
						<tr>
							<th><div><?php echo get_phrase('test_name');?></div></th>
							<th><div><?php echo get_phrase('subject');?></div></th>
							<th><div><?php echo get_phrase('test_date');?></div></th>
