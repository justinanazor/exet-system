...
<div class="" style="text-align: left; border:1px solid green; padding-left:10px">
    ...
    <?php endif ?>
		...
		<table class="table ">
			<thead>
                <tr>
                    <th><div style="color: #000; font-size:20px"><?php echo get_phrase('student_name');?></div></th>
                    <th><div style="color: #000; font-size:20px"><?php echo get_phrase('obtained_marks');?></div></th>
                    <th><div style="color: #000; font-size:20px"><?php echo get_phrase('result');?></div></th>
                </tr>
            </thead>
            <tbody>
            	<?php 
