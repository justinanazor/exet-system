	...
	<div class="col-sm-12">
		<div class="panel panel-info">
			<div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('view_results');?></div>
				...
				<a href="<?php  echo site_url('student/online_exam'); ?>" class="btn btn-default" style="color:#000">
					<?php echo get_phrase('active_exams');?>
				</a>
				<a href="<?php echo site_url('student/online_exam_result'); ?>" class="btn btn-<?php echo $data2 == 'active' ? 'primary' : 'white'; ?>" style="color:#000">
							...
							<tr>
								...
								<td>
									<?php if ($current_time > $exam_end_time): ?>
										<a href="#" type="button" class = "btn btn-success btn-rounded btn-sm" onclick="showAjaxModal('<?php echo site_url('modal/popup/modal_show_answer_script/'.$row['online_exam_id']);?>');" style="color:white">
