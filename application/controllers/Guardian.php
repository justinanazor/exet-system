...
class Guardian extends CI_Controller { 
    ...
    public function index() {
        if($this->session->userdata('guardian_login') != 1) redirect(base_url(). 'login', 'refresh');
        if($this->session->userdata('guardian_login') == 1) redirect(base_url(). 'guardian/dashboard', 'refresh');
    ...
    function dashboard() {
        ...
        $page_data['page_title'] =  get_phrase('Guardian Dashboard');
    ...
    function manage_request ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == ''){
            ...
            $match = array('status !=' => 'expired', 'running_year' => $running_year, 'p_status !=' => '');
    ...
    function manage_request_status($request_id = null, $status = null){
        $this->crud_model->manage_request_parent_status($request_id, $status);
        redirect(site_url('guardian/manage_request'), 'refresh');
    }
    ...
    /* function video($param1 = null, $param2 = null){
        $page_data['page_name'] = 'online_video';
        $page_data['page_title'] = get_phrase('Student Video');
        $this->load->view('backend/index', $page_data);
    }
